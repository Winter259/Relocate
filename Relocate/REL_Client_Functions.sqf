...
REL_AssignPreSafetyAddaction = {
    ...
    if (
    ([_player] call REL_IsAdmin || !isMultiplayer) && 
    REL_AllowPreSafetyDeploy && 
    (REL_AllowPresafetyDeploy_BLU || 
    REL_AllowPresafetyDeploy_OPF || 
    REL_AllowPresafetyDeploy_IND || 
    REL_AllowPresafetyDeploy_CIV)
    ) then {
